...
<c:forEach  items="${articlePage.list}"  var="comment">
...
<div class="row"> 
	<nav aria-label="Page navigation example" >
					  <ul class="pagination ">
					    ...
					    <li class="page-item">
					      <a class="page-link" href="javascript:gopage(${articlePage.pageNum-1})" aria-label="Previous">
					    ...
					    <li class="page-item">
					      <a class="page-link" href="javascript:gopage(${articlePage.pageNum+1})" aria-label="Next">
